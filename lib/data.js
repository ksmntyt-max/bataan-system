...
export const MUNICIPALITIES = [
  ...
  { id:'pilar',       name:'Pilar',         lat:14.659, lng:120.723, zonalMin:400,   zonalMax:2500,  pop:22140,  areaHa:5400,  zoning:['Agricultural','Residential'],               features:['Manila Bay Shoreline','Wetland Sanctuary'],               powerScore:.60, portScore:.45, roadScore:.55, r:4.5, sez:false },
...
// Accurate Bataan province polygon — traced clockwise from SW tip
export const BATAAN_OUTLINE = [
  // Southern tip — Mariveles / Cape Capuluan
  [14.420,120.455],[14.432,120.442],[14.448,120.432],[14.463,120.423],
  [14.485,120.413],[14.510,120.406],[14.533,120.400],[14.556,120.394],
  [14.578,120.388], // Bagac Bay SW coast
  [14.598,120.370],[14.616,120.348],[14.634,120.323],[14.655,120.300],
  [14.672,120.282],[14.689,120.264], // Morong / BNPP area (westernmost)
  [14.705,120.262],[14.720,120.265],[14.738,120.278],[14.758,120.300],
  [14.778,120.332],[14.800,120.360],[14.820,120.387],[14.841,120.408],
  [14.860,120.422],[14.875,120.436],[14.888,120.447], // NW — Subic Bay coastal ridge
  // Northern border — Zambales → Pampanga boundary
  [14.900,120.458],[14.910,120.470],[14.914,120.484],
  [14.913,120.498],[14.907,120.512],[14.898,120.526],[14.884,120.540],
  // East coast — Manila Bay, going south
  [14.866,120.548],[14.843,120.550],[14.818,120.548],[14.795,120.545],
  [14.773,120.551],[14.753,120.553],[14.730,120.540],
  [14.706,120.541],[14.682,120.538], // Balanga / Abucay area
  // Eastern protrusion — Pilar peninsula into Manila Bay
  [14.673,120.548],[14.668,120.578],[14.662,120.630],
  [14.657,120.693],[14.648,120.706], // Pilar eastern tip
  [14.637,120.695],[14.626,120.660],[14.614,120.635],
  [14.603,120.626], // Orion coast
  [14.588,120.638],[14.572,120.630],[14.556,120.612],
  [14.540,120.596],[14.524,120.578],[14.506,120.558],
  [14.487,120.536],[14.467,120.518],[14.449,120.504],
  [14.435,120.490],[14.426,120.478],[14.421,120.465],[14.420,120.455],
]

// Corregidor Island — small island south of Bataan tip in Manila Bay
export const CORREGIDOR_ISLAND = [
  [14.390,120.547],[14.394,120.560],[14.396,120.575],[14.393,120.590],
  [14.387,120.597],[14.378,120.592],[14.373,120.576],[14.375,120.560],
  [14.382,120.548],[14.390,120.547],
]
